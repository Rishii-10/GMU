...
|---|---|---|
| **Rule Engine Design (Final)** | [`RULE_ENGINE_DESIGN_FINAL.md`](RULE_ENGINE_DESIGN_FINAL.md) | Complete rule engine design: CP gate, AHP scorer, adaptive follow-up, models, validation results (1,000-case), fixes F1–F4, Mermaid diagrams, known limitations |
